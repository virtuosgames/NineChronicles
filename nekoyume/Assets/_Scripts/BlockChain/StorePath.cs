...
namespace Nekoyume.BlockChain
{
    public static class StorePath
    {
        ...
        public static string GetDefaultStoragePath(Env? env = null)
        {
            ...
            // Android/IPhonePlayer: Application.persistentDataPath/DefaultStorage
            if (UnityEngine.Application.platform == UnityEngine.RuntimePlatform.Android
                || UnityEngine.Application.platform == UnityEngine.RuntimePlatform.IPhonePlayer)
            {
                return Path.Combine(Application.persistentDataPath, "DefaultStorage");
            }
        ...
        public static string GetPrefixPath()
        {
            ...
            if (UnityEngine.Application.platform == UnityEngine.RuntimePlatform.Android
                || UnityEngine.Application.platform == UnityEngine.RuntimePlatform.IPhonePlayer)
            {
                return Path.Combine(Application.persistentDataPath, "planetarium");
            }
