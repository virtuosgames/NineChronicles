...
#pragma warning restore IDE1006
        ...
        public static T Import<T>(INativeLibImporter importer, string libName, string version, bool suppressUnload) where T : class
        {
            ...
            if (UnityEngine.Application.platform == UnityEngine.RuntimePlatform.Android)
            {
                ...
                string suspicionPath = Path.GetDirectoryName(typeof(PosixImporter).GetTypeInfo().Assembly.Location);
                suspicionPath = suspicionPath.Split("/base.apk")[0];
                suspicionPath += "/lib/arm/librocksdb.so";
                lib = importer.LoadLibrary(suspicionPath);
                if (lib == IntPtr.Zero)
            ...
            var basePaths = new string[] {
                nativeCodeBase,
                "D:/NineChronicles/NineChro/nekoyume/Assets/Packages/runtimes/win-x64/native",
